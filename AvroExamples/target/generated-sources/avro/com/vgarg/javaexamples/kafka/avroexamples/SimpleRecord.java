...
public class SimpleRecord extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 5313905825636103517L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"SimpleRecord\",\"namespace\":\"com.vgarg.javaexamples.kafka.avroexamples\",\"fields\":[{\"name\":\"data\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}]}");
   ...
   */
  public SimpleRecord(java.lang.String data) {
    this.data = data;
  }
   ...
   */
  public static com.vgarg.javaexamples.kafka.avroexamples.SimpleRecord.Builder newBuilder() {
    return new com.vgarg.javaexamples.kafka.avroexamples.SimpleRecord.Builder();
  }
   ...
   * @return A new SimpleRecord RecordBuilder
   */
  public static com.vgarg.javaexamples.kafka.avroexamples.SimpleRecord.Builder newBuilder(com.vgarg.javaexamples.kafka.avroexamples.SimpleRecord.Builder other) {
    if (other == null) {
      return new com.vgarg.javaexamples.kafka.avroexamples.SimpleRecord.Builder();
    } else {
      return new com.vgarg.javaexamples.kafka.avroexamples.SimpleRecord.Builder(other);
    }
  }
   ...
   * @return A new SimpleRecord RecordBuilder
   */
  public static com.vgarg.javaexamples.kafka.avroexamples.SimpleRecord.Builder newBuilder(com.vgarg.javaexamples.kafka.avroexamples.SimpleRecord other) {
    if (other == null) {
      return new com.vgarg.javaexamples.kafka.avroexamples.SimpleRecord.Builder();
    } else {
      return new com.vgarg.javaexamples.kafka.avroexamples.SimpleRecord.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<SimpleRecord>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.vgarg.javaexamples.kafka.avroexamples.SimpleRecord.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.vgarg.javaexamples.kafka.avroexamples.SimpleRecord other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.data)) {
        this.data = data().deepCopy(fields()[0].schema(), other.data);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.vgarg.javaexamples.kafka.avroexamples.SimpleRecord.Builder setData(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.vgarg.javaexamples.kafka.avroexamples.SimpleRecord.Builder clearData() {
      data = null;
